...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	//handleMethodArgumentNotValid() args:
	//			ex: the exception. (ie. MethodArgumentNotValidException)
	...
	// HttpRequestMethodNotSupportedException
		...
		@ExceptionHandler(UserNameNotFoundException.class)		//annotation to allow this exception handler to deal with 'usernamenotfound'
